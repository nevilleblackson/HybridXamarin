...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("RSR.Droid.MapActivity_, RSR.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MapActivity_.class, __md_methods);
	}


	public MapActivity_ () throws java.lang.Throwable
	{
		super ();
		if (getClass () == MapActivity_.class)
			mono.android.TypeManager.Activate ("RSR.Droid.MapActivity_, RSR.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
